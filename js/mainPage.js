const membersInfo = [
	['res/AboutUs/蘇克倫.png', '蘇克倫', '主負責人', '商務公司行銷企劃'],
	['res/AboutUs/孫姊.png', '孫如廷', '營運負責人', '美國在臺協會實習'],
	['res/AboutUs/陳柏偉.png', '陳柏偉', '美術設計', '成功大學工設系碩二'],
	['res/AboutUs/楊宜芳.png', '楊宜芳', '前端負責人', '成功大學資工系畢業生'],
	['res/AboutUs/Eason.png', '張羿軒', '後端負責人', '成功大學資訊系大二'],
